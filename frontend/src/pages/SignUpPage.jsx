...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${BACKEND_URL}/v1/user`, formData, {
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-5 py-4 text-base rounded-xl border border-gray-300 bg-gray-50 focus:ring-4 focus:ring-purple-100 focus:border-purple-600 outline-none transition-all duration-200 ease-in-out hover:bg-gray-50/80 shadow-sm cursor-pointer"
              >
